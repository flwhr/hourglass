...
from commands import clubs_cmd, ops_cmd, links_cmd, tier_cmd
from commands import admin_cmd, club_admin_cmd, members_cmd, status_cmd
from commands import board_cmd
from db import clubs
from db import history as history_repo
from reports.images import render_progress_chart, render_trainer_card
from services.scheduler import run_due_clubs
    ...
    async def member_status(interaction: discord.Interaction, club: str, trainer_name: str):
        ...
        try:
            ...
            if member is None:
                ...
                return
            from db import bombs as _bombs
